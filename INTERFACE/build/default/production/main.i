...
# 13 "./MCAL/GPIO/../std_types.h"
# 1 "./MCAL/GPIO/../std_libraries.h" 1
# 13 "./MCAL/GPIO/../std_libraries.h"
...
# 13 "./MCAL/GPIO/../compiler.h" 2
# 14 "./MCAL/GPIO/../std_types.h" 2
...
# 14 "./MCAL/GPIO/gpio.h" 2

# 1 "./MCAL/GPIO/../device_config.h" 1
# 15 "./MCAL/GPIO/gpio.h" 2
# 30 "./MCAL/GPIO/gpio.h"
typedef enum
{
    OUTPUT =0,
...
# 1 "./ECU/KEYPAD/keypad.h" 1
# 19 "./ECU/KEYPAD/keypad.h"
typedef struct{
    pin_config rows[4];
    pin_config coloums[4];
}keypad;
...
# 1 "./ECU/7_SEGMENT/_7_segment.h" 1
# 17 "./ECU/7_SEGMENT/_7_segment.h"
typedef struct{
...
# 1 "./ECU/DC_motor/dc_motor.h" 1
# 19 "./ECU/DC_motor/dc_motor.h"
typedef struct{
    pin_config motor[2];
}motor_t;
...
lcd_8_bit_mode lcd_1={
  .rs.pin=PIN0,.rs.port=PORTC_INDEX,.rs.direction=OUTPUT,.rs.state=0,
  .en.pin=PIN1,.en.port=PORTC_INDEX,.en.direction=OUTPUT,.en.state=0,
  ._8_bit[0].pin=PIN2,._8_bit[0].port=PORTC_INDEX,._8_bit[0].state=0,._8_bit[0].direction=OUTPUT,
  ._8_bit[1].pin=PIN3,._8_bit[1].port=PORTC_INDEX,._8_bit[1].state=0,._8_bit[1].direction=OUTPUT,
  ._8_bit[2].pin=PIN4,._8_bit[2].port=PORTC_INDEX,._8_bit[2].state=0,._8_bit[2].direction=OUTPUT,
  ._8_bit[3].pin=PIN5,._8_bit[3].port=PORTC_INDEX,._8_bit[3].state=0,._8_bit[3].direction=OUTPUT,
  ._8_bit[4].pin=PIN6,._8_bit[4].port=PORTC_INDEX,._8_bit[4].state=0,._8_bit[4].direction=OUTPUT,
  ._8_bit[5].pin=PIN7,._8_bit[5].port=PORTC_INDEX,._8_bit[5].state=0,._8_bit[5].direction=OUTPUT,
  ._8_bit[6].pin=PIN0,._8_bit[6].port=PORTD_INDEX,._8_bit[6].state=0,._8_bit[6].direction=OUTPUT,
  ._8_bit[7].pin=PIN1,._8_bit[7].port=PORTD_INDEX,._8_bit[7].state=0,._8_bit[7].direction=OUTPUT,
